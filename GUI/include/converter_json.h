...
public:
    ...
    */
    void putConfig(ConfigList settings, QList<QString> files,QString path);
...
private:
    ...
    QString config_file_path = "config.json";       //Путь до файла конфигурации //Configuration file`s path
    QString requests_file_path = "requests.json";   //Путь до файла запросов //Requests file`s path
    QString answers_file_path = "answers.json";     //Путь до файла ответов //Answers file`s path
